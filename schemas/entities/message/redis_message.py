...
class ParameterData(BaseModel):
    ...
    # 趋势报告的生成内容
    markdown: Optional[str] = Field(default=None, description="趋势报告的生成文本")
...
class BaseRedisMessage(BaseModel):
    ...
    status: str
    content_type: int
    content: Union[None, TextMessageContent, WithActionContent, CustomDataContent, ParameterDataContent, SuggestionContent, PhaseProgressContent]
