...
# @Time     : 2025/12/18 17:03
# @File     : abroad_progress_template.py
from app.schemas.entities.workflow.progress_template import (
    PhaseTemplate,
    WorkflowProgressTemplate,
)

ABROAD_INS_PROGRESS_TEMPLATE = WorkflowProgressTemplate(
    task_name="选品任务",
    phases=[
        PhaseTemplate(
            name="选品任务规划",
...
__all__ = ["ABROAD_INS_PROGRESS_TEMPLATE"]
