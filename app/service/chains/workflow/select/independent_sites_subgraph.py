...
class IndependentSitesSubGraph:
    ...
    def _output_node(self, state: IndependentSitesSubGraphState) -> dict[str, Any]:
        ...
        if fallback_attempted:
            ...
            final_params = state.get("secondary_params")
            final_request_path = state.get("secondary_request_path", "")
            ...
            final_params = state.get("primary_params")
            final_request_path = state.get("primary_request_path", "")
