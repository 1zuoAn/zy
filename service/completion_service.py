...
COMPLETION_MODEL = LlmModelName.OPENROUTER_GEMINI_2_5_FLASH
...
## 输出规则
1.（最重要） 只输出【补全部分】，不重复用户已输入内容（比如用户输入“帮我找黑色的”你得补全“羽绒服、适合秋冬穿”，而不能是“的羽绒服，适合秋冬穿”）（比如用户输入“我想要分析淘宝2025年7月女装连衣裙的销售趋势”，你应该补全“的报告”，而不是“的销售趋势报告”，补全内容要和用户输入相关，语言要自然
