...
from pydantic import AliasChoices, BaseModel, Field, field_validator, ConfigDict, model_validator
...
class DouyiGoodsEntity(BaseModel):
    ...
    item_id: Optional[str] = Field(default=None, alias="itemId", description="商品ID")

    # ===== 基础信息 =====
    title: Optional[str] = Field(default=None, alias="title")
    goods_title: Optional[str] = Field(default=None, alias="goodsTitle", description="商品标题")
    pic_url: Optional[str] = Field(default=None, alias="picUrl")
    pic_url_list: Optional[List[str]] = Field(default=None, alias="picUrlList", description="商品图片列表")
    image_num: Optional[int] = Field(default=None, alias="imageNum", description="图片数量")

    # ===== 类目信息 =====
    root_category_id: Optional[int] = Field(default=None, alias="rootCategoryId", description="根类目ID")
    root_category_name: Optional[str] = Field(default=None, alias="rootCategoryName", description="根类目名称")
    category_id: Optional[int] = Field(default=None, alias="categoryId", description="类目ID")
    category_name: Optional[str] = Field(default=None, alias="categoryName", description="类目名称")

    # ===== 价格信息 =====
    price: Optional[int] = Field(default=None, alias="price")
    goods_price: Optional[int] = Field(default=None, alias="goodsPrice", description="商品价格（分）")
    cprice: Optional[int] = Field(default=None, alias="cprice", description="C端价格（分）")
    sprice: Optional[int] = Field(default=None, alias="sprice", description="划线价（分）")
    min_price: Optional[int] = Field(default=None, alias="minPrice", description="最低价（分）")
    max_price: Optional[int] = Field(default=None, alias="maxPrice", description="最高价（分）")
    min_price_30day: Optional[int] = Field(default=None, alias="minPrice30day", description="30天最低价")
    sku_min_price: Optional[int] = Field(default=None, alias="skuMinPrice", description="SKU最低价")
    sku_max_price: Optional[int] = Field(default=None, alias="skuMaxPrice", description="SKU最高价")
    period_latest_s_price: Optional[int] = Field(default=None, alias="periodLatestSPrice", description="周期最新S价（分）")
    period_latest_c_price: Optional[int] = Field(default=None, alias="periodLatestCPrice", description="周期最新C价（分）")

    # ===== 销量/销售额数据 =====
    # 总体数据
    total_sale_volume: Optional[int] = Field(default=None, alias="totalSaleVolume", description="累计总销量")
    total_sale_amount: Optional[int] = Field(default=None, alias="totalSaleAmount", description="累计总销售额（分）")

    # 新增销量（按渠道）
    new_sale_volume: Optional[int] = Field(default=None, alias="newSaleVolume", description="周期总销量")
    new_live_sale_volume: Optional[int] = Field(default=None, alias="newLiveSaleVolume", description="周期直播销量")
    new_video_sale_volume: Optional[int] = Field(default=None, alias="newVideoSaleVolume", description="周期作品销量")
    new_card_sale_volume: Optional[int] = Field(default=None, alias="newCardSaleVolume", description="周期商品卡销量")

    # 新增销售额（按渠道）
    new_sale_amount: Optional[int] = Field(default=None, alias="newSaleAmount", description="周期总销售额（分）")
    new_live_sale_amount: Optional[int] = Field(default=None, alias="newLiveSaleAmount", description="周期直播销售额")
    new_video_sale_amount: Optional[int] = Field(default=None, alias="newVideoSaleAmount", description="周期作品销售额")
    new_card_sale_amount: Optional[int] = Field(default=None, alias="newCardSaleAmount", description="周期商品卡销售额")

    # 近期销量统计
    sale_volume: Optional[int] = Field(default=None, alias="saleVolume", description="总销量")
    sale_amount: Optional[int] = Field(default=None, alias="saleAmount", description="总销售额（分）")
    sale_volume_yesterday: Optional[int] = Field(default=None, alias="saleVolumeYesterday", description="昨日销量")
    sale_volume_3day: Optional[int] = Field(default=None, alias="saleVolume3day", description="近3天销量")
    sale_volume_7day: Optional[int] = Field(default=None, alias="saleVolume7day", description="近7天销量")
    sale_volume_15day: Optional[int] = Field(default=None, alias="saleVolume15day", description="近15天销量")
    sale_volume_30day: Optional[int] = Field(default=None, alias="saleVolume30day", description="近30天销量")

    # 近期销售额统计
    sale_amount_yesterday: Optional[int] = Field(default=None, alias="saleAmountYesterday", description="昨日销售额")
    sale_amount_3day: Optional[int] = Field(default=None, alias="saleAmount3day", description="近3天销售额")
    sale_amount_7day: Optional[int] = Field(default=None, alias="saleAmount7day", description="近7天销售额")
    sale_amount_15day: Optional[int] = Field(default=None, alias="saleAmount15day", description="近15天销售额")
    sale_amount_30day: Optional[int] = Field(default=None, alias="saleAmount30day", description="近30天销售额")

    # ===== 互动数据 =====
    total_view_num: Optional[int] = Field(default=None, alias="totalViewNum", description="总浏览数")
    total_comment_num: Optional[int] = Field(default=None, alias="totalCommentNum", description="总评论数")
    new_view_num: Optional[int] = Field(default=None, alias="newViewNum", description="周期浏览数")
    new_comment_num: Optional[int] = Field(default=None, alias="newCommentNum", description="周期评论数")
    view_num_yesterday: Optional[int] = Field(default=None, alias="viewNumYesterday", description="昨日浏览数")
    view_num_3day: Optional[int] = Field(default=None, alias="viewNum3day", description="近3天浏览数")
    view_num_7day: Optional[int] = Field(default=None, alias="viewNum7day", description="近7天浏览数")
    view_num_15day: Optional[int] = Field(default=None, alias="viewNum15day", description="近15天浏览数")
    view_num_30day: Optional[int] = Field(default=None, alias="viewNum30day", description="近30天浏览数")
    comment_num_30day: Optional[int] = Field(default=None, alias="commentNum30day", description="近30天评论数")
    video_like_num_30day: Optional[int] = Field(default=None, alias="videoLikeNum30day", description="近30天视频点赞数")

    # ===== 店铺信息 =====
    shop_id: Optional[int] = Field(default=None, alias="shopId", description="店铺ID")
    shop_name: Optional[str] = Field(default=None, alias="shopName")
    shop_logo: Optional[str] = Field(default=None, alias="shopLogo", description="店铺Logo")

    # ===== 品牌和属性 =====
    brand: Optional[str] = Field(default=None, alias="brand", description="品牌")
    properties: Optional[List[str]] = Field(default=None, alias="properties", description="属性列表")
    export_properties: Optional[str] = Field(default=None, alias="exportProperties", description="导出属性")

    # ===== 时间数据 =====
    first_record_date: Optional[str] = Field(default=None, alias="firstRecordDate")
    first_record_time: Optional[str] = Field(default=None, alias="firstRecordTime", description="首次记录时间")
    update_time: Optional[str] = Field(default=None, alias="updateTime", description="更新时间")
    latest_sale_date: Optional[str] = Field(default=None, alias="latestSaleDate", description="最新销售日期")

    # ===== 商品类型标识 =====
    goods_type: Optional[int] = Field(default=None, alias="goodsType", description="商品类型")
    is_live_item: Optional[int] = Field(default=None, alias="isLiveItem", description="是否直播商品")
    is_video_item: Optional[int] = Field(default=None, alias="isVideoItem", description="是否作品商品")
    is_card_item: Optional[int] = Field(default=None, alias="isCardItem", description="是否商品卡商品")
    is_live_hot_sale_item: Optional[int] = Field(default=None, alias="isLiveHotSaleItem", description="是否直播热销商品")
    is_recorded: Optional[bool] = Field(default=None, alias="isRecorded", description="是否已记录")

    # ===== 统计周期 =====
    statistic_time: Optional[str] = Field(default=None, alias="statisticTime", description="统计时间")

    # ===== 嵌套对象：抖音商品数据 =====
    douyin_goods: Optional["DouyiGoodsNested"] = Field(default=None, alias="douyinGoods", description="抖音商品数据")
...
class ZhiyiPriceRangeTrendRequest(BaseModel):
    ...
    range_list: list[str] | None = Field(default=None, alias="rangeList")
...
# ========== 知衣大盘分析(HYDC)请求模型 - 对齐n8n实际使用的端点 ==========

class ZhiyiHydcTrendListRequest(BaseModel):
    """大盘趋势数据统一请求 - /hydc/trend-list
    ...
    category_id_list: Optional[List[int]] = Field(default=None, alias="categoryIdList")
    shop_type: Optional[str] = Field(default=None, alias="shopType")
    is_mall_item: Optional[bool] = Field(default=None, alias="isMallItem")
    start_date: str = Field(alias="startDate")
    end_date: str = Field(alias="endDate")
    top: int = Field(default=5)
    group_type: str = Field(alias="groupType", description="overview|cprice|color|property|brand")
    order_type: str = Field(default="saleVolume", alias="orderType")
    date_type: str = Field(alias="dateType", description="week|month")
    # 可选参数（特定groupType使用）
    price_bind_list: Optional[List[str]] = Field(default=None, alias="priceBindList")
    property_name: Optional[str] = Field(default=None, alias="propertyName")
    property_list: Optional[List] = Field(default=None, alias="propertyList")
    brand_name: Optional[str] = Field(default=None, alias="brandName")
    type: Optional[str] = Field(default=None)


class ZhiyiHydcRankItemRequest(BaseModel):
    """大盘商品排名请求 - /v2-5-6/rank/item-list-v3"""
    model_config = ConfigDict(populate_by_name=True)
    ...
    start_date: str = Field(alias="startDate")
    end_date: str = Field(alias="endDate")
    property_type: int = Field(default=2, alias="propertyType")
    wise_filter_flag: int = Field(default=1, alias="wiseFilterFlag")
    time_flag: int = Field(default=2, alias="timeFlag")
    type: str = Field(default="item-rank")
    entrance: int = Field(default=2)
    limit: int = Field(default=10)
    rank_status: str = Field(default="saleVolume", alias="rankStatus")
    page_no: int = Field(default=1, alias="pageNo")
    page_size: int = Field(default=10, alias="pageSize")


# ========== 知衣大盘分析(HYDC)响应模型 - /hydc/trend-list ==========

class HydcTrendItem(BaseModel):
    """大盘趋势时序数据项"""
    model_config = ConfigDict(populate_by_name=True)

    agg_field: Optional[str] = Field(default=None, alias="aggField")
    agg_date: Optional[str] = Field(default=None, alias="aggDate")
    sale_volume: Optional[str] = Field(default=None, alias="saleVolume")
    sale_volume_yoy: Optional[str] = Field(default=None, alias="saleVolumeYoy")
    sale_amount: Optional[str] = Field(default=None, alias="saleAmount")
    sale_amount_yoy: Optional[str] = Field(default=None, alias="saleAmountYoy")
    new_sale_num: Optional[str] = Field(default=None, alias="newSaleNum")
    new_sale_num_yoy: Optional[str] = Field(default=None, alias="newSaleNumYoy")


class HydcTrendResultItem(BaseModel):
    """大盘趋势分组结果项"""
    model_config = ConfigDict(populate_by_name=True)

    agg_key: Optional[str] = Field(default=None, alias="aggKey")
    agg_field: Optional[str] = Field(default=None, alias="aggField")
    agg_name: Optional[str] = Field(default=None, alias="aggName")
    metric_num: Optional[str] = Field(default=None, alias="metricNum")
    metric_percent: Optional[float] = Field(default=None, alias="metricPercent")
    trend_list: List[HydcTrendItem] = Field(default_factory=list, alias="trendList")


class HydcTrendListRawResponse(BaseModel):
    """大盘趋势数据原始响应 - /hydc/trend-list"""
    model_config = ConfigDict(populate_by_name=True)

    success: bool = Field(default=True)
    result: List[HydcTrendResultItem] | None = Field(default_factory=list)
...
class ShopHotItemRawItem(BaseModel):
    ...
    pic_url_list: Optional[List[str]] = Field(default=None, alias="picUrlList")
    article_no: Optional[str] = Field(default=None, alias="articleNo")  # 货号
    style_no: Optional[str] = Field(default=None, alias="styleNo")  # 款号
    ...
    max_c_price: Optional[int] = Field(default=None, alias="maxCPrice")
    min_price: Optional[str] = Field(default=None, alias="minPrice")
    coupon_cprice: Optional[int] = Field(default=None, alias="couponCprice")
    avg_coupon_cprice: Optional[int] = Field(default=None, alias="avgCouponCprice")
    cprice: Optional[int] = Field(default=None, alias="cprice")
    sprice: Optional[int] = Field(default=None, alias="sprice")
    ...
    agg_collection: Optional[int] = Field(default=None, alias="aggCollection")

    # 近期销量统计
    sale_7day: Optional[int] = Field(default=None, alias="sale7day")
    sale_30day: Optional[int] = Field(default=None, alias="sale30day")
    sale_amount_7day: Optional[int] = Field(default=None, alias="saleAmount7day")
    sale_amount_30day: Optional[int] = Field(default=None, alias="saleAmount30day")

    # 首发期间销量
    first_day_sale: Optional[int] = Field(default=None, alias="firstDaySale")
    first_day_sales_volume: Optional[int] = Field(default=None, alias="firstDaySalesVolume")
    first_week_sale: Optional[int] = Field(default=None, alias="firstWeekSale")
    first_week_sales_volume: Optional[int] = Field(default=None, alias="firstWeekSalesVolume")
    first_month_sale: Optional[int] = Field(default=None, alias="firstMonthSale")
    first_month_sales_volume: Optional[int] = Field(default=None, alias="firstMonthSalesVolume")
    first_3day_sale: Optional[int] = Field(default=None, alias="first3daySale")
    first_3day_sales_volume: Optional[int] = Field(default=None, alias="first3daySalesVolume")
    first_14day_sales_volume: Optional[int] = Field(default=None, alias="first14daySalesVolume")

    # ===== 互动数据 =====
    collect: Optional[int] = Field(default=None, alias="collect")
    comment_count: Optional[int] = Field(default=None, alias="commentCount")
    collect_30day: Optional[int] = Field(default=None, alias="collect30day")
    sale_time_30day_collect: Optional[int] = Field(default=None, alias="saleTime30dayCollect")
    sale_time_14day_collect: Optional[int] = Field(default=None, alias="saleTime14dayCollect")
    sale_time_7day_collect: Optional[int] = Field(default=None, alias="saleTime7dayCollect")
    sale_time_3day_collect: Optional[int] = Field(default=None, alias="saleTime3dayCollect")
    sale_collect_rate: Optional[float] = Field(default=None, alias="saleCollectRate")

    # ===== 店铺信息 =====
    shop_id: Optional[int] = Field(default=None, alias="shopId")
    shop_name: Optional[str] = Field(default=None, alias="shopName")
    shop_logo: Optional[str] = Field(default=None, alias="shopLogo")
    shop_logo_url: Optional[str] = Field(default=None, alias="shopLogoUrl")
    shop_type: Optional[int] = Field(default=None, alias="shopType")
    shop_grade: Optional[int] = Field(default=None, alias="shopGrade")
    shop_label: Optional[str] = Field(default=None, alias="shopLabel")
    shop_style: Optional[str] = Field(default=None, alias="shopStyle")
    ...
    origin_properties: Optional[Dict[str, Any]] = Field(default=None, alias="originProperties")
    item_sizes: Optional[List[str]] = Field(default=None, alias="itemSizes")
    year_season: Optional[str] = Field(default=None, alias="yearSeason")
    delivery: Optional[str] = Field(default=None, alias="delivery")
    colors: Optional[str] = Field(default=None, alias="colors")
    cloth: Optional[str] = Field(default=None, alias="cloth")
    fabric: Optional[str] = Field(default=None, alias="fabric")
    material: Optional[List[str]] = Field(default=None, alias="material")
    material_composition: Optional[str] = Field(default=None, alias="materialComposition")

    # ===== 时间数据 =====
    sale_time: Optional[str] = Field(default=None, alias="saleTime")
    first_insert_time: Optional[str] = Field(default=None, alias="firstInsertTime")
    cancel_time: Optional[str] = Field(default=None, alias="cancelTime")
    nearly_sale_time: Optional[str] = Field(default=None, alias="nearlySaleTime")
    start_sell_date: Optional[str] = Field(default=None, alias="startSellDate")
    sale_30day_insert_time: Optional[str] = Field(default=None, alias="sale30dayInsertTime")

    # ===== 库存和SKU =====
    stock: Optional[int] = Field(default=None, alias="stock")
    shelves: Optional[int] = Field(default=None, alias="shelves")
    first_day_stock: Optional[int] = Field(default=None, alias="firstDayStock")
    first_day_sku_num: Optional[int] = Field(default=None, alias="firstDaySkuNum")
    start_sell_stock: Optional[int] = Field(default=None, alias="startSellStock")
    start_sell_sku_num: Optional[int] = Field(default=None, alias="startSellSkuNum")

    # ===== 状态标识 =====
    jhs_status: Optional[int] = Field(default=None, alias="jhsStatus")
    record_status: Optional[int] = Field(default=None, alias="recordStatus")
    pre_sale_status: Optional[int] = Field(default=None, alias="preSaleStatus")
    pre_sale_flag: Optional[bool] = Field(default=None, alias="preSaleFlag")
    collect_flag: Optional[bool] = Field(default=None, alias="collectFlag")
    contrast_flag: Optional[bool] = Field(default=None, alias="contrastFlag")

    # ===== 排名和推荐 =====
    rank: Optional[int] = Field(default=None, alias="rank")
    rank_name: Optional[str] = Field(default=None, alias="rankName")
    daily_top_sale_volume: Optional[int] = Field(default=None, alias="dailyTopSaleVolume")
    daily_top_sale_date: Optional[str] = Field(default=None, alias="dailyTopSaleDate")

    # ===== 同环比数据 =====
    sales_volume_mtm_ratio: Optional[float] = Field(default=None, alias="salesVolumeMtmRatio")
    sales_amount_mtm_ratio: Optional[float] = Field(default=None, alias="salesAmountMtmRatio")
    collection_mtm_ratio: Optional[float] = Field(default=None, alias="collectionMtmRatio")
    sales_volume_yty_ratio: Optional[float] = Field(default=None, alias="salesVolumeYtyRatio")
    sales_amount_yty_ratio: Optional[float] = Field(default=None, alias="salesAmountYtyRatio")

    # ===== 历史价格 =====
    history_min_left_cprice: Optional[int] = Field(default=None, alias="historyMinLeftCprice")
    history_min_right_cprice: Optional[int] = Field(default=None, alias="historyMinRightCprice")
    history_min_cprice_date: Optional[str] = Field(default=None, alias="historyMinCpriceDate")
    history_max_left_cprice: Optional[int] = Field(default=None, alias="historyMaxLeftCprice")
...
class CategoryTrendRawResponse(BaseModel):
    """品类趋势原始响应"""
    success: bool = True
    result: List[CategoryTrendRawItem] | None
...
class PropertyTopRawItem(BaseModel):
    ...
    property_value: list[str] | None = Field(default=None, alias="propertyValue")


class PropertyTopRawResponse(BaseModel):
    """属性列表原始响应"""
    success: bool = True
    result: list[PropertyTopRawItem] | None
...
class SaleTrendSlimItem(BaseModel):
    ...
    granularity_date: Optional[str] = Field(default=None, alias="granularityDate")
    insert_date: str | None = Field(default=None, alias="insertDate")
...
class PriceRangeSlimItem(BaseModel):
    ...
    left_price: int | None = Field(alias="leftPrice")
    right_price: int | None = Field(alias="rightPrice")
    sales_volume: int | None = Field(default=0, alias="salesVolume")
...
class DouyiPropertySelectorRequest(BaseModel):
    """抖衣属性选择器请求 - 对应 /douyin-common/item/property-selector-list"""
    model_config = ConfigDict(populate_by_name=True)
...
class DouyiPropertySelectorRawItem(BaseModel):
    ...
    label: str | None = Field(default=None, alias="label", description="属性名称")
    children: list[str] | None = Field(default=None, alias="children", description="属性值对象列表")

    @model_validator(mode="before")
    @classmethod
    def _normalize_selector_payload(cls, values: Any) -> Any:
        if isinstance(values, dict):
            if "propertyName" not in values and "label" in values:
                values["propertyName"] = values.get("label")
            if "propertyValueList" not in values and "children" in values:
                children = values.get("children") or []
                values["propertyValueList"] = [
                    {"propertyValueName": item} for item in children if isinstance(item, str) and item.strip()
                ]
        return values
