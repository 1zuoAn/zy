...
class ZhiyiAPI:
    ...
    def get_hydc_sale_trend(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcTrendRequest,
    ) -> SaleTrendRawResponse:
        """获取大盘销售趋势数据 - /v1-6-2/hydc/trend/sale-trend"""
        data = self._request(
            method="POST",
            path="/v1-6-2/hydc/trend/sale-trend",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
    ...
    def get_hydc_price_range_trend(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcPriceRangeRequest,
    ) -> PriceRangeRawResponse:
        """获取大盘价格带趋势数据 - /v2-3-1/hydc/trend/price-range-trend"""
        data = self._request(
            method="POST",
            path="/v2-3-1/hydc/trend/price-range-trend",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
    ...
    def get_hydc_property_trend(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcPropertyRequest,
    ) -> PropertyTrendRawResponse:
        """获取大盘属性/颜色趋势数据 - /v1-6-0/hydc/trend/property-trend"""
        data = self._request(
            method="POST",
            path="/v1-6-0/hydc/trend/property-trend",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
    ...
    def get_hydc_brand_trend(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcBrandRequest,
    ) -> BrandRawResponse:
        """获取大盘品牌趋势数据 - /v1-6-0/hydc/trend/brand-trend"""
        data = self._request(
            method="POST",
            path="/v1-6-0/hydc/trend/brand-trend",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
        return BrandRawResponse.model_validate(data)

    def get_hydc_category_trend(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcCategoryRequest,
    ) -> CategoryTrendRawResponse:
        """获取大盘品类趋势数据 - /v1-6-0/hydc/trend/category-trend"""
        data = self._request(
            method="POST",
            path="/v1-6-0/hydc/trend/category-trend",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
    ...
    def get_hydc_hot_items(
        self,
        user_id: int,
        team_id: int,
        params: ZhiyiHydcTopItemRequest,
    ) -> ShopHotItemRawResponse:
        """获取大盘热销商品Top10 - /v2-0-x/hydc/item/hot-item-list"""
        data = self._request(
            method="POST",
            path="/v2-0-x/hydc/item/hot-item-list",
            user_id=user_id,
            team_id=team_id,
            json=params.model_dump(by_alias=True, exclude_none=True),
        )
    ...
    def get_douyi_property_selector(
        ...
        """抖衣属性选择器 - /douyin-common/item/item-property-selector-list

        获取指定品类下可用的属性列表，用于属性分析时的属性选择。
        """
        data = self._request(
            method="GET",
            path="/douyin-common/item/item-property-selector-list",
            user_id=user_id,
            team_id=team_id,
            params=params.model_dump(by_alias=True, exclude_none=True),
        )
