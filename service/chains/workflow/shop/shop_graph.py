...
class ShopGraph(BaseWorkflowGraph):
    ...
    def _init_state_node(self, state: ShopWorkflowState) -> Dict[str, Any]:
        return {}

    def _package_result_node(self, state: ShopWorkflowState) -> Dict[str, Any]:
        response = WorkflowResponse(select_result="店铺排行功能暂未接入", relate_data=None)
