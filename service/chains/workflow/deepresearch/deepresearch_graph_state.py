...
from app.service.chains.workflow.deepresearch.zhiyi.schema import ZhiyiParsedCategory, ZhiyiThinkingApiParseParam
...
from app.service.rpc.zhiyi.schemas import (
    ...
    BrandCleanResponse, DouyiTopItemsRawResponse,
)
...
class ZhiyiDeepresearchState(BaseDeepresearchGraphState):
    ...
    # 属性分析辅助
    property_name: str | None = Field(default=None, description="提取的属性名称")
    property_list: List[Dict] = Field(default=None, description="可用属性列表")
    # 价格分析辅助
...
class DouyiDeepresearchState(BaseDeepresearchGraphState):
    ...
    category_top_resp: DouyiTopItemsRawResponse | None = Field(default=None, description="品类分支-Top商品源结果")
    ...
    property_top_resp: DouyiTopItemsRawResponse | None = Field(default=None, description="属性分支-Top商品源结果")
    ...
    price_top_resp: DouyiTopItemsRawResponse | None = Field(default=None, description="价格带分支-Top商品源结果")
