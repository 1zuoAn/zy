...
from app.service.rpc.zhiyi.schemas import DouyiTopItemsRawResponse
...
class DouyiAggregatedData(BaseModel):
    ...
    top_products_origin: DouyiTopItemsRawResponse | None = Field(default=None, alias="topProductsOrigin", description="top商品的原始查询结果")