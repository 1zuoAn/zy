...
from app.service.rpc.zhiyi.schemas import DouyiGoodsEntity
...
class DouyiAggregatedData(BaseModel):
    ...
    top_products_origin: PageResult[DouyiGoodsEntity] | None = Field(default=None, alias="topProductsOrigin", description="top商品的原始查询结果")